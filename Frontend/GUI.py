...
class ChatSection(QWidget):
       ...
       def loadMessages(self):
            ...
            with open("Frontend/Files/Responses.data", "r", encoding="utf-8") as file:
                  messages = file.read()
...
class InitialScreen(QWidget):
       ...
       def __init__(self, parent=None):
            ...
            custom_width = 950
            max_gif_size_H = int(screen_width * 7 / 16)
            movie.setScaledSize(QSize(custom_width, max_gif_size_H))
